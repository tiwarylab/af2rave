...
class FeatureSelection:
    ...
    def get_peptide_bondlengths(self) -> dict[str, NDArray[np.float_]]:
        '''
        Get the first and second moment of the peptide bondlengths generated by AF2.

        :return: dict: A dictionary of pdb names and their peptide bondlength's 
                        mean and standard deviation values. Units: Angstrom.
        ...
        dists=md.compute_distances(self._traj,atom_pairs=np.vstack((sel_N[1:],sel_C[:-1])).T)*10
        means = dists.mean(1)
    ...
    def get_minimum_nonbonded_distances(self)-> dict[str, float]:
        '''
        Get the minimum non-bonded distances in the structures generated by AF2.

        :return: dict: A dictionary of pdb names and their minimum non-bonded 
                        heavy atom distances mean and standard deviation values. Units: Angstrom.
        :rtype: dict[str, float]
        '''
    ...
    def peptide_bond_filter(self, mean_cutoff = 1.4, std_cutoff = 0.2) -> list[str]:
        ...
        This method uses the first and second moment of the peptide bonds for 
        filtering purpose.
        '''
    ...
    def steric_clash_filter(self, min_non_bonded_cutoff = 1.0) -> list[str]:
        '''
        Filter structures with a non-bonded heavy atom dists cutoff.

        Some AlphaFold2 generated structures have steric clashes 
        between non-bonded atoms. This method filters out such structures 
        with non-bonded heavy atom distances that too short leading to 
        overlap in their Vand der Waal's radii.
        '''
